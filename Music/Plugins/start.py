...
def start_pannel():
    buttons = [
        ...
        [
            InlineKeyboardButton("📚 ᴄᴏᴍᴍᴀɴᴅ​ 📚", url="https://github.com/Kenzuuu/Shinobi-Musik/blob/Kenzhu/Button_Music.txt"),
        ],
        [
            InlineKeyboardButton("🌐 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 🌐", url="https://t.me/triplenineee"),
        ],
    ]
    return (
